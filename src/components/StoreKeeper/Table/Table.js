  ...
  return (
    ...
    <div className="card card-primary  c-test">
        <div className="card-header">
            <h3 className="card-title">Store Keeper List</h3>
        </div>
            ...
            <table id="example2" className="table table-bordered table-hover ">
                <thead >
                    <tr>
                        ...
                        <th className='c-column-name' >Store Keeper Name</th>
                        ...
                        data.displayData.map((item,index)=>{
                            return(
                                ...
                                <tr key={item.id}>
                                    ...
                                    <td>{item.name}</td>
                                    <td className='pl-5'>
                                        <button onClick={(e)=>{ change.deleteStoreKeeper(item.id) }} className='btn btn-danger mr-4'>Delete</button>
                                    </td>
                                </tr>
